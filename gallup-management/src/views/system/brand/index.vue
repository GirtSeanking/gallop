<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="brandList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="品牌简介" align="center" prop="brandDes" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="品牌简介" prop="brandDes">
          <el-input v-model="form.brandDes" placeholder="请输入品牌简介" />
        </el-form-item>
...
<script>
import { listBrand, getBrand, delBrand, addBrand, updateBrand, changeBrandStatus } from "@/api/system/brand";
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.brandName + '"品牌吗？').then(function() {
        return changeBrandStatus(row.brandId, row.status);
      }).then(() => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除品牌信息编号为"' + brandIds + '"的数据项？').then(function() {
